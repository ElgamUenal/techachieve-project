    ...
    <div class="wrapper">
      <div class="container">
        ...
        <div id="scene" class="scene" data-hover-only="false">
          ...
          <p class="p404" data-depth="0.50">TechAchieve</p>
          <p class="p404" data-depth="0.10">TechAchieve</p>
        </div>
...
<script>
// Importiere Parallax.js für den Parallax-Effekt
...
body {
  ...
  background: #000000; /* Schwarz als Hintergrund */
}
...
.logo {
  ...
  justify-content: center;
  align-items: center;
  background: rgba(255, 255, 255, 0.1); /* Weiß mit Transparenz */
  border-radius: 100%;
  backdrop-filter: blur(5px);
}
.logo img {
...
nav .menu .menu_links .link:before {
  ...
  width: 0px;
  height: 4px;
  background: linear-gradient(90deg, #ff0000 0%, #cc0000 100%); /* Rot */
  bottom: -10px;
  border-radius: 4px;
...
.wrapper .container .text article p {
  ...
  margin-bottom: 40px;
  text-shadow: 6px 6px 10px #000000; /* Schwarz */
}
.wrapper .container .text article button {
  ...
  border-radius: 50px;
  cursor: pointer;
  box-shadow: 0px 15px 20px rgba(0, 0, 0, 0.5); /* Schwarz */
  z-index: 3;
  color: #000000; /* Schwarz */
...
.wrapper .container .text article button:hover {
  box-shadow: 0px 10px 10px -10px rgba(0, 0, 0, 0.5); /* Schwarz */
...
.wrapper .container .circle:before {
  ...
  width: 800px;
  height: 800px;
  background-color: rgba(0, 0, 0, 0.2); /* Schwarz mit Transparenz */
  border-radius: 100%;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
  box-shadow: inset 5px 20px 40px rgba(0, 0, 0, 0.25), inset 5px 0px 5px rgba(0, 0, 0, 0.3), inset 5px 5px 20px rgba(0, 0, 0, 0.25), 2px 2px 5px rgba(255, 255, 255, 0.2);
...
.wrapper .container .one .content:before {
  ...
  width: 600px;
  height: 600px;
  background-color: rgba(0, 0, 0, 0.3); /* Schwarz mit Transparenz */
  border-radius: 100%;
  box-shadow: inset 5px 20px 40px rgba(255, 255, 255, 0.25), inset 5px 0px 5px rgba(255, 255, 255, 0.3), inset 5px 5px 20px rgba(255, 255, 255, 0.25), 2px 2px 5px rgba(0, 0, 0, 0.2);
...
.wrapper .container .one .content .piece {
  background: linear-gradient(90deg, #ff0000 13.7%, #cc0000 94.65%); /* Rot */
}
...
.wrapper .container .two .content .piece {
  background: linear-gradient(90deg, #ffffff 0%, #cccccc 100%); /* Weiß zu Grau */
}
